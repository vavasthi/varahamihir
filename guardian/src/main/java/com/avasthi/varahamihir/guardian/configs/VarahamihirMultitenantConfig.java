...
@EntityScan(basePackages = {"com.avasthi.varahamihir.guardian.entities"})
public class VarahamihirMultitenantConfig {
  ...
  public LocalContainerEntityManagerFactoryBean multiEntityManager() {
    ...
    em.setPackagesToScan("com.avasthi.varahamihir.guardian.entities");
  ...
  public LocalSessionFactoryBean dbSessionFactory() {
    ...
    sessionFactoryBean.setPackagesToScan("com.avasthi.varahamihir.guardian.entities");
