 ...
 */
public class VarahamihirUUIDIntPair implements Serializable {

    private UUID first;
    private Integer second;

    public VarahamihirUUIDIntPair() {
    }

    public VarahamihirUUIDIntPair(UUID first, Integer second) {
        this.first = first;
        this.second = second;
    }
    ...
    public boolean equals(Object o) {
        ...
        VarahamihirUUIDIntPair that = (VarahamihirUUIDIntPair) o;
