 ...
 */
public class VarahamihirOAuthTokenPrincipal implements Principal {


  public VarahamihirOAuthTokenPrincipal(Optional<String> token, Optional<String> tokenType, Optional<String> authorizationHeader) {
