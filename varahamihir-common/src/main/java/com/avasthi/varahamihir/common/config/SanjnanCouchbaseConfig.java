...
public class SanjnanCouchbaseConfig extends AbstractCouchbaseConfiguration  {
  ...
  @Value("${com.sanjnan.rae.common.couchbase.bootstraphosts:localhost:8082}")
  private String bootStrapHosts;

  @Value("${com.sanjnan.rae.common.couchbase.bucketName:identity}")
  private String bucketName;

  @Value("${com.sanjnan.rae.common.couchbase.bucketPassword:identity123}")
  private String bucketPassword;

  @Value("${com.sanjnan.rae.common.couchbase.username:identity}")
  private String couchbaseUsername;

  @Value("${com.sanjnan.rae.common.couchbase.password:identity123}")
