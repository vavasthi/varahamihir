 ...
 */
public class H2OUUIDStringPair  implements Serializable {
  public H2OUUIDStringPair() {
  }

  public H2OUUIDStringPair(UUID first, String second) {
    this.first = first;
    this.second = second;
  }
  ...
  public boolean equals(Object o) {
    ...
    H2OUUIDStringPair that = (H2OUUIDStringPair) o;
