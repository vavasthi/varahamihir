 ...
 */
public class VarahamihirTokenPrincipal extends VarahamihirPrincipal {


  public VarahamihirTokenPrincipal(Optional<String> remoteAddr,
  ...
  public String toString() {
    return "VarahamihirTokenPrincipal{" +
        "token=" + token +
        "} " + super.toString();
  }
