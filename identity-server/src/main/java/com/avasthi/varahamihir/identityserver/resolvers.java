...
public class resolvers {
  public static class VarahamihirAuthenticationManagerResolver implements ReactiveAuthenticationManagerResolver<ServerWebExchange> {
    ...
    public Mono<ReactiveAuthenticationManager> resolve(ServerWebExchange serverWebExchange) {
      ...
      return ServerWebExchangeMatchers
              .pathMatchers("/*/login", "/*/registration/user")
