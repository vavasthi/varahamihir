...
import com.avasthi.varahamihir.identityserver.configs.VarahaJWTReactiveAuthManager;
import com.avasthi.varahamihir.identityserver.converters.VarahamihirJWTAuthConverters;
...
@Component
public class VarahamihirJWTAuthWebFilter implements WebFilter {

  private final VarahamihirJWTUtil jwtUtil;

  private final Function<ServerWebExchange, Mono<Authentication>> jwtAuthConverter;
  private final ReactiveAuthenticationManager reactiveAuthManager = new VarahaJWTReactiveAuthManager();
  ...
  public VarahamihirJWTAuthWebFilter(VarahamihirJWTUtil jwtUtil) {
    this.jwtUtil = jwtUtil;
    this .jwtAuthConverter = new VarahamihirJWTAuthConverters(jwtUtil);
  }
  @Override
