...
import com.avasthi.varahamihir.common.pojos.VarahamihirUsernameAndTokenResponse;
 ...
 */
@Service
public class VarahamihirTokenService {
   ...
   */
  public VarahamihirUsernameAndTokenResponse contains(String remoteAddr,
  ...
  public Session create(String remoteAddr,
    ...
    try {
        ...
        if (accountOptional.isPresent()) {
          ...
          if (VarahamihirPasswordEncryptionManager.INSTANCE.matches(password, account.getPassword())) {
   ...
   * @throws DatatypeConfigurationException
   */
  public VarahamihirUsernameAndTokenResponse refresh(Account account,
                                                     Session session,
                                                     String remoteAddr)
          throws DatatypeConfigurationException {
  ...
  private VarahamihirUsernameAndTokenResponse validateAppToken(String remoteAddr,
                                                               String applicationId,
                                                               String authToken,
      ...
      if (sessionOptional.isPresent()) {
        ...
        if (accountOptional.isPresent()) {
          ...
          if (session.getClientId().equals(applicationId)) {
            ...
            return new VarahamihirUsernameAndTokenResponse(account.getEmail(),
                    new VarahamihirTokenResponse(authToken,
                            "",
                            account.getComputeRegion(),
                            session.getExpiry(),
                            account.getVarahamihirRoles()));
          }
        }
      } else {
  ...
  private VarahamihirUsernameAndTokenResponse refreshAppToken(Account account,
                                                              Session session,
                                                              String remoteAddr)
          throws DatatypeConfigurationException {
          ...
          VarahamihirUsernameAndTokenResponse response =  assignAuthTokenToUser(account, session, account.getEmail());
          return response;
  }
  public Session assignAuthTokenToUser(Account account,
    ...
    expiry = expiry.plusSeconds(VarahamihirConstants.TOKEN_EXPIRY_SECONDS);
    Session session
            = new Session(account,
   ...
   */
  @Transactional
  public VarahamihirUsernameAndTokenResponse assignAuthTokenToUser(Account account,
                                                                   Session session,
                                                                   String username)
          throws DatatypeConfigurationException {
    ...
    sessionRepository.save(session);
    return new VarahamihirUsernameAndTokenResponse(username,
            new VarahamihirTokenResponse(session.getAuthToken(),
                    session.getRefreshToken(),
                    account.getComputeRegion(),
                    session.getExpiry(),
                    account.getVarahamihirRoles()));
  }
  public VarahamihirUsernameAndTokenResponse deleteToken(Account account,
                                                         Session session)
          throws DatatypeConfigurationException {
